...
RAID = [
    ...
    "GABBAR OP HU MADARCHOD TERI MAA KI CHUT ME GHUTKA KHAAKE THOOK DUNGA 🤣🤣",
    "GABBAR OP HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    "GABBAR OP HU TERI VAHEEN NHI HAI KYA? 9 MAHINE RUK SAGI VAHEEN DETA HU 🤣🤣🤩",
    "GABBAR OP HU TERI MAA K BHOSDE ME AEROPLANEPARK KARKE UDAAN BHAR DUGA ✈️🛫",
    "GABBAR OP HU TERI MAA KI CHUT ME SUTLI BOMB FOD DUNGA TERI MAA KI JHAATE JAL KE KHAAK HO JAYEGI💣",
    "GABBAR OP HU TERI MAAKI CHUT ME SCOOTER DAAL DUGA👅",
    "GABBAR OP HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    "GABBAR OP HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    "GABBAR OP HU TERI MAA KI CHUT KAKTE 🤱 GALI KE KUTTO 🦮 ME BAAT DUNGA PHIR 🍞 BREAD KI TARH KHAYENGE WO TERI MAA KI CHUT",
    "GABBAR OP HU DUDH HILAAUNGA TERI VAHEEN KE UPR NICHE 🆙🆒😙",
    "GABBAR OP HU TERI MAA KI CHUT ME ✋ HATTH DALKE 👶 BACCHE NIKAL DUNGA 😍",
    "GABBAR OP HU TERI BEHN KI CHUT ME KELE KE CHILKE 🍌🍌😍",
    "GABBAR OP HU TERI BHEN KI CHUT ME USERBOT LAGAAUNGA SASTE SPAM KE CHODE",
    "GABBAR OP HU TERI VAHEEN DHANDHE VAALI 😋😛",
    "GABBAR OP HU TERI MAA KE BHOSDE ME AC LAGA DUNGA SAARI GARMI NIKAL JAAYEGI",
    "GABBAR OP HU TERI VAHEEN KO HORLICKS PEELAUNGA MADARCHOD😚",
    "GABBAR OP HU TERI MAA KI GAAND ME SARIYA DAAL DUNGA MADARCHOD USI SARIYE PR TANG KE BACHE PAIDA HONGE 😱😱",
    "GABBAR OP HU TERI MAA KO KOLKATA VAALE JITU BHAIYA KA LUND MUBARAK 🤩🤩",
    "GABBAR OP HU TERI MUMMY KI FANTASY HU LAWDE, TU APNI BHEN KO SMBHAAL 😈😈",
    "GABBAR OP HU TERA PEHLA KAAL HU MADARCHOD ",
    "GABBAR OP HU TERI VAHEEN KE BHOSDE ME XVIDEOS.COM CHALA KE MUTH MAARUNGA 🤡😹",
...
RRAID = [
    "GABBAR OP HU MADARCHOD",
    "GABBAR OP HU BHOSDIKE",
    "GABBAR OP HU LAAAWEEE KE BAAAAAL",
